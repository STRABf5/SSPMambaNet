...
def bbox_iou(box1, box2, x1y1x2y2=True,mpdiou_hw=None, GIoU=False, DIoU=False, CIoU=False, MPDIOU=False,eps=1e-7):
    ...
    if GIoU or DIoU or CIoU:
        ...
        d1= lfte_x**2 + lfte_y**2 + eps
        d2 = right_w**2 + right_h**2 + eps
        return iou - d1 / mpdiou_hw - d2 / mpdiou_hw  # MPDIoU  # IoU   
    else:
        return iou  # IoU
